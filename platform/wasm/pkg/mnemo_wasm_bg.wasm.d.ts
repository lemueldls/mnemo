...
export const typststate_setPt: (a: number, b: number, c: number) => void;
export const typststate_setSize: (a: number, b: number, c: number) => void;
...
export const typststate_resize: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
