...
if (Symbol.dispose) FileId.prototype[Symbol.dispose] = FileId.prototype.free;
...
export class TypstState {
    ...
    checkHTML(id, text, prelude) {
        ...
        const ptr1 = passStringToWasm0(prelude, wasm.__wbindgen_export, wasm.__wbindgen_export2);
     ...
     * @returns {FileId}
     */
    createSourceId(path, space_id) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(space_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.typststate_createSourceId(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return FileId.__wrap(ret);
    }
    /**
     * @param {FileId} id
    ...
    jumpHTML(id, element) {
        _assertClass(id, FileId);
        const ptr0 = passArray32ToWasm0(element, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
     ...
     * @param {string} text
     * @param {string} prelude
     * @returns {RenderHtmlResult}
     */
    renderHtml(id, text, prelude) {
        _assertClass(id, FileId);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(prelude, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.typststate_renderHtml(this.__wbg_ptr, id.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
     * @param {FileId} id
    ...
    setFont(id, font) {
        _assertClass(id, FileId);
        const ptr0 = passStringToWasm0(font, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.typststate_setFont(this.__wbg_ptr, id.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {FileId} id
     * @param {string} locale
    ...
    /**
     * @param {FileId} id
     * @param {string | null} [math_font]
     */
    setMathFont(id, math_font) {
        _assertClass(id, FileId);
        var ptr0 = isLikeNone(math_font) ? 0 : passStringToWasm0(math_font, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        var len0 = WASM_VECTOR_LEN;
        wasm.typststate_setMathFont(this.__wbg_ptr, id.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {FileId} id
...
if (Symbol.dispose) TypstState.prototype[Symbol.dispose] = TypstState.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_debug_ec6b0fef1d3b1406: function(arg0, arg1) {
        ...
        __wbg_error_9b26091973deca3d: function(arg0, arg1) {
            console.error(getStringFromWasm0(arg0, arg1));
        },
        ...
        __wbg_log_72ae7d649933552f: function(arg0, arg1) {
