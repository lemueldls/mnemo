...
use std::{cmp, fmt::Write, hash::BuildHasher, iter, ops::Range};
...
use typst::{
    __bail as bail, WorldExt, compile,
...
pub fn render_by_elements(id: &TypstFileId, text: &str, prelude: &str, state: &mut TypstState) {
