...
makedepends=('cargo' 'pnpm' 'nodejs' 'git' 'file' 'appmenu-gtk-module' 'libappindicator-gtk3' 'librsvg' 'base-devel' 'curl' 'wget' 'rustup' 'webkit2gtk-4.1') options=('!strip' '!emptydirs')
...
package() {
   # use the intermediate artifacts generated by the bundler for creating the .deb
    cd "\${srcdir}/\${_builddir}/target/release/bundle/deb/mnemo-v\${pkgver}-amd64/data" || exit 1
