...
export function __wbg_packagefile_free(a: number, b: number): void;
export function packagefile_new(a: number, b: number, c: number, d: number): number;
export function __wbg_themecolors_free(a: number, b: number): void;
...
export function __wbg_typststate_free(a: number, b: number): void;
...
export function __wbg_fileid_free(a: number, b: number): void;
...
export function typststate_renderPdf(a: number, b: number): Array;
export function typststate_click(a: number, b: number, c: number, d: number): number;
export function typststate_autocomplete(a: number, b: number, c: number): Array;
